...
<table>
  ...
  <tr>
    <td>Ico.Component</td>
    <td>n/a</td>
    <td>base class of all components</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Ico.Component.ValueLabels<td></td>
    <td>value_labels</td>
    <td></td>
  </tr>
  <tr>
...
h4. Ico.Base options
* width: canvas width, defaults to DOM element width
* height: canvas height, defaults to DOM element height
* color: defaults to DOM element color
* mouseover_attributes: for data elements
**stroke: color, defaults to 'red'
* orientation: 0 for vertical (default), 1 for horizontal
