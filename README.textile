...
<pre><code>
new Ico.SparkLine( $( 'sparkline' ), [5,2,-1,17,23,15,7,6,-5,-2,4,7,3,9] );
</code></pre>
...
Grpahs features are driven by components. Each graph type defines different default components and graph orientation (horizontal or vertical).
Default components can be disabled by explicitly setting the property to false.
