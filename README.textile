...
* (deprecated, cannot specify display order) A hash where:
...
// An array of values for a single serie graph
data_series = [5, 2, -1, 17, 23, 15, 7, 6, -5, -2, 4, 7, 3, 9]

// An array of arrays of values for multiple series graphs
data_series = [
...
<table>
  ...
  <tr>
    <td>grid</td>
    <td>false</td>
    <td>Controls display of grid associated with labels</td>
  </tr>
  <tr>
    <td>grid_attributes</td>
    <td></td>
    <td>Attributes for grid lines</td>
  </tr>
  <tr>
    <td>grid_attributes.stroke</td>
    <td></td>
    <td>Stroke color for grid lines</td>
  </tr>
  <tr>
    <td>grid_attributes['stroke-width']</td>
    <td></td>
    <td>Stroke width for grid lines</td>
  </tr>
  <tr>
    <td>axis</td>
    <td></td>
...
<table>
  ...
  <tr>
    <td>dot_radius</td>
    <td>3 pixels</td>
    <td>Radius of dots for values, 0 => not value dot displayed</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>focus_radius</td>
    <td>6 pixels</td>
    <td>Radius of focus, 0 => disable mouse over action</td>
  </tr>
  <tr>
...
<table>
  ...
  <tr>
    <td>grid</td>
    <td>Ico.Base or Ico.BaseGraph grid</td>
    <td>Control display of grid associated with labels, overrides global grid attribute value</td>
  </tr>
  <tr>
    <td>grid_attributes</td>
    <td>Ico.base or Ico.BaseGraph grid_attributes</td>
    <td>Control grid attributes associated with labels, overrides global attributes</td>
  </tr>
</table>
...
h1. Target 1.0 milestone

This section outlines the projected improvements to be released with version 1.0.

Features:
* Display Value Labels Title either above the y axis, in the status bar or under value labels if horizontal graph
* Add Title component, displayed centered in the graph area, above the background layer 
* Add Legend component, displayed centered in the status bar for now
...
API:
* Provide cleaner and more intuitive API.
...
* Remove prototype dependency, should also work w/ jQuery, Mootools sh/could probably become js library agnostic as most of the browser specific code is in Raphael itself. Another possibility could be to release Ico with an optional subset of Prototype compatible with other JavaScript frameworks.
