...
<table>
  ...
  <tr>
    ...
    <td>Line color for line graphs</td>
  </tr>
  <tr>
    <td>dot_radius</td>
    <td>5 pixels</td>
    <td>Radius of dots for line graphs</td>
  </tr>
  <tr>
    <td>dot_attributes</td>
    <td>See bellow</td>
    <td>Hash by data series key for line graphs dots</td>
  </tr>
  <tr>
    <td>dot_attributes[serie_key]['stroke-width']</td>
    <td>1 pixel</td>
    <td>Dot stroke width for line serie</td>
  </tr>
  <tr>
    <td>dot_attributes[serie_key].stroke</td>
    <td>background color || options.color</td>
    <td>Dot color for line serie</td>
  </tr>
  <tr>
    <td>dot_attributes[serie_key].fill</td>
    <td></td>
    <td>Dot fill color for line series</td>
  </tr>
</table>
